...
class Configuration():
	def __init__(self):
		...
		self.MODEL_SAVE_DIR = os.path.join(self.ROOT_DIR,'saved_models',self.EXP_NAME)
		...
		self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,'saved_models/deeplabv3+voc/deeplabv3plus_res101_atrous_VOC2012_itr0.pth')

		self.LOG_DIR = os.path.join(self.ROOT_DIR,'logs',self.EXP_NAME)

		self.TEST_MULTISCALE = [0.5, 0.75, 1.0, 1.25, 1.5, 1.75]
		self.TEST_FLIP = True
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'saved_models/deeplabv3+voc/deeplabv3plus_res101_atrous_VOC2012_itr0.pth')
		self.TEST_GPUS = 4
